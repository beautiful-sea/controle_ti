...
<div class="timeline-badge"><a style="color: inherit;" href="{{route('ordem_servicos.edit',App\OrdemServico::find($n->data['ordemServico']))}}"><i class="fa fa-phone-volume"></i></a></div>
