...
{
    protected $fillable = ['equipamento_id','usuario_id','cadastrante_id','setor_id','descricao','resolucao','status','servico_executado','tipo_manutencao','resolvido_confirmado','para_setor_ti'];
